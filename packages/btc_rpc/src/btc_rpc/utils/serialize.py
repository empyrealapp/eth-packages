# FROM: https://github.com/petertodd/python-bitcoinlib/blob/master/bitcoin/core/serialize.py
...
class Serializable(object):
    ...
    def deserialize(cls, buf, allow_padding=False, params={}):
        ...
        if not allow_padding:
            padding = fd.read()
            if len(padding) != 0:
                raise DeserializationExtraDataError("Not all bytes consumed during deserialization", r, padding)
        return r
