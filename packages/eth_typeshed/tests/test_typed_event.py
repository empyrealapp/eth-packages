...
def test_process_event() -> None:
    ...
    assert swap.get_topic0 == "0xd78ad95fa46c994b6551d0da85fc275fe613ce37657fb8d5e3d130840159d822"

    response = swap.process(
        topics=[
            HexStr("0xd78ad95fa46c994b6551d0da85fc275fe613ce37657fb8d5e3d130840159d822"),
            HexStr("0x0000000000000000000000003328f7f4a1d1c57c35df56bbf0c9dcafca309c49"),
            HexStr("0x0000000000000000000000003e33de444802886a8041717f57e0f42a89b118d2"),
        ],
        data=HexStr(
