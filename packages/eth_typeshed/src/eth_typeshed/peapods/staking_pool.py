...
class StakingPool(ERC20):
    pool_rewards: Annotated[ContractFunc[NoArgs, HexAddress], Name("poolRewards")] = METHOD
    index_fund: Annotated[ContractFunc[NoArgs, HexAddress], Name("indexFund")] = METHOD
    staking_token: Annotated[ContractFunc[NoArgs, HexAddress], Name("stakingToken")] = METHOD
