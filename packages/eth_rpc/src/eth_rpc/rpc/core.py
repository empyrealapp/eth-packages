...
class RPC(BaseRPC):
    ...
    max_priority_fee_per_gas: ClassVar = RPCMethod[Empty, HexInteger](name="eth_maxPriorityFeePerGas")
    ...
    get_block_by_hash: ClassVar = RPCMethod[GetBlockByHashArgs, Block](name="eth_getBlockByHash")
    get_block_by_number: ClassVar = RPCMethod[GetBlockByNumberArgs, Block](name="eth_getBlockByNumber")
    get_block_tx_count_by_number: ClassVar = RPCMethod[BlockNumberArg, HexInteger](
        name="eth_getBlockTransactionCountByNumber",
    )
    get_tx_by_hash: ClassVar = RPCMethod[TransactionRequest, Transaction | None](name="eth_getTransactionByHash")
    get_pending_tx_by_hash: ClassVar = RPCMethod[TransactionRequest, PendingTransaction | None](
        name="eth_getTransactionByHash"
    )
    estimate_gas: ClassVar = RPCMethod[CallWithBlockArgs, HexInteger](name="eth_estimateGas")
    block_number: ClassVar = RPCMethod[Empty, HexInteger](name="eth_blockNumber")
    create_access_list: ClassVar = RPCMethod[CallWithBlockArgs, AccessListResponse](name="eth_createAccessList")
    get_storage_at: ClassVar = RPCMethod[GetStorageArgs, HexStr](name="eth_getStorageAt")
    ...
    get_block_receipts: ClassVar = RPCMethod[list[HexInteger | HexStr], list[TransactionReceipt]](
        name="eth_getBlockReceipts"
    )
    alchemy_get_block_receipts: ClassVar = RPCMethod[AlchemyBlockReceipt, AlchemyReceiptsResponse](
        name="alchemy_getTransactionReceipts"
    )
    get_tx_by_block_hash: ClassVar = RPCMethod[GetTransactionByBlockHash, Transaction](
        name="eth_getTransactionByBlockHashAndIndex"
    )
    get_tx_by_block_number: ClassVar = RPCMethod[GetTransactionByBlockNumber, Transaction](
    ...
    get_tx_count: ClassVar = RPCMethod[GetAccountArgs, HexInteger](name="eth_getTransactionCount")
    get_logs: ClassVar = RPCMethod[LogsArgs, list[Log]](name="eth_getLogs")

    send_raw_tx: ClassVar = RPCMethod[RawTransaction, HexStr](name="eth_sendRawTransaction")
